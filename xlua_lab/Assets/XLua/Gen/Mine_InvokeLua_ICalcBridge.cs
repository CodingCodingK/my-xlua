...
{
    public class MineInvokeLuaICalcBridge : LuaBase, Mine.InvokeLua.ICalc
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new MineInvokeLuaICalcBridge(reference, luaenv);
		}
		
		public MineInvokeLuaICalcBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		int Mine.InvokeLua.ICalc.Add(int a, int b)
		{
		...
		event System.EventHandler<Mine.InvokeLua.PropertyChangedEventArgs> Mine.InvokeLua.ICalc.PropertyChanged
		{
			add
			{
#if THREAD_SAFE || HOTFIX_ENABLE
        ...
        object Mine.InvokeLua.ICalc.this[int index]
		{
		    get
			{
#if THREAD_SAFE || HOTFIX_ENABLE
