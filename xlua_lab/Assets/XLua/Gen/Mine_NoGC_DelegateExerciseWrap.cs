...
namespace XLua.CSObjectWrap
{
    ...
    public class MineNoGC_DelegateExerciseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Mine.NoGC_DelegateExercise);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Mine.NoGC_DelegateExercise();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Mine.NoGC_DelegateExercise constructor!");
        ...
        static int _m_FloatParamMethod(RealStatePtr L)
        {
		    try {
                ...
                Mine.NoGC_DelegateExercise gen_to_be_invoked = (Mine.NoGC_DelegateExercise)translator.FastGetCSObj(L, 1);
        ...
        static int _m_StructParamMethod(RealStatePtr L)
        {
		    try {
                ...
                {
                    Mine.DIUStruct _p;translator.Get(L, 2, out _p);
                    
                        var gen_ret = gen_to_be_invoked.StructParamMethod( _p );
                        translator.PushMineDIUStruct(L, gen_ret);
        ...
        static int _m_EnumParamMethod(RealStatePtr L)
        {
		    try {
                ...
                {
                    Mine.DIUEnum _p;translator.Get(L, 2, out _p);
                    
                        var gen_ret = gen_to_be_invoked.EnumParamMethod( _p );
                        translator.PushMineDIUEnum(L, gen_ret);
        ...
        static int _s_set_a3(RealStatePtr L)
        {
		    try {
                ...
                Mine.NoGC_DelegateExercise gen_to_be_invoked = (Mine.NoGC_DelegateExercise)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.a3 = (Mine.DIUStruct[])translator.GetObject(L, 2, typeof(Mine.DIUStruct[]));
        ...
        static int _s_set_a4(RealStatePtr L)
        {
		    try {
                ...
                Mine.NoGC_DelegateExercise gen_to_be_invoked = (Mine.NoGC_DelegateExercise)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.a4 = (Mine.DIUEnum[])translator.GetObject(L, 2, typeof(Mine.DIUEnum[]));
