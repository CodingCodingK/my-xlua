...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public Mine.DIUStruct __Gen_Delegate_Imp11(Mine.DIUStruct p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                int errFunc = LuaAPI.pcall_prepare(L, errorFuncRef, luaReference);
                ObjectTranslator translator = luaEnv.translator;
                translator.PushMineDIUStruct(L, p0);
                
                PCall(L, 1, 1, errFunc);
                
                
                Mine.DIUStruct __gen_ret;translator.Get(L, errFunc + 1, out __gen_ret);
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public Mine.DIUEnum __Gen_Delegate_Imp12(Mine.DIUEnum p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                int errFunc = LuaAPI.pcall_prepare(L, errorFuncRef, luaReference);
                ObjectTranslator translator = luaEnv.translator;
                translator.PushMineDIUEnum(L, p0);
                
                PCall(L, 1, 1, errFunc);
                
                
                Mine.DIUEnum __gen_ret;translator.Get(L, errFunc + 1, out __gen_ret);
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public Mine.InvokeLua.ICalc __Gen_Delegate_Imp16(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                Mine.InvokeLua.ICalc __gen_ret = (Mine.InvokeLua.ICalc)translator.GetObject(L, errFunc + 1, typeof(Mine.InvokeLua.ICalc));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(Mine.IntDelegate))
			{
			    return new Mine.IntDelegate(__Gen_Delegate_Imp4);
			}
		    ...
		    if (type == typeof(Mine.Vector3Delegate))
			{
			    return new Mine.Vector3Delegate(__Gen_Delegate_Imp5);
			}
		    ...
		    if (type == typeof(Mine.DecimalDelegate))
			{
			    return new Mine.DecimalDelegate(__Gen_Delegate_Imp8);
			}
		    ...
		    if (type == typeof(Mine.ArrayExchanger))
			{
			    return new Mine.ArrayExchanger(__Gen_Delegate_Imp9);
			}
		    ...
		    if (type == typeof(Mine.CustomStructTypeDelegate))
			{
			    return new Mine.CustomStructTypeDelegate(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(Mine.EnumDelegate))
			{
			    return new Mine.EnumDelegate(__Gen_Delegate_Imp12);
			}
		    ...
		    if (type == typeof(Mine.InvokeLua.CalcNew))
			{
			    return new Mine.InvokeLua.CalcNew(__Gen_Delegate_Imp16);
			}
