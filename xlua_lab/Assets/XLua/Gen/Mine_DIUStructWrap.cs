...
namespace XLua.CSObjectWrap
{
    ...
    public class MineDIUStructWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Mine.DIUStruct);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
					...
					var gen_ret = new Mine.DIUStruct(_p1, _p2);
				...
				{
				    translator.PushMineDIUStruct(L, default(Mine.DIUStruct));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Mine.DIUStruct constructor!");
        ...
        static int _g_get_a(RealStatePtr L)
        {
		    try {
                ...
                Mine.DIUStruct gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int _g_get_e(RealStatePtr L)
        {
		    try {
                ...
                Mine.DIUStruct gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushMinePedding(L, gen_to_be_invoked.e);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_a(RealStatePtr L)
        {
		    try {
                ...
                translator.UpdateMineDIUStruct(L, 1, gen_to_be_invoked);
        ...
        static int _s_set_e(RealStatePtr L)
        {
		    try {
                ...
                Mine.DIUStruct gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                Mine.Pedding gen_value;translator.Get(L, 2, out gen_value);
