...
namespace XLua.CSObjectWrap
{
    ...
    public class MinePeddingWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Mine.Pedding);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.PushMinePedding(L, default(Mine.Pedding));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Mine.Pedding constructor!");
        ...
        static int _g_get_c(RealStatePtr L)
        {
		    try {
                ...
                Mine.Pedding gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int _s_set_c(RealStatePtr L)
        {
		    try {
                ...
                translator.UpdateMinePedding(L, 1, gen_to_be_invoked);
